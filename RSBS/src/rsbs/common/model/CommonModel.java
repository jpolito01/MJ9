...
public class CommonModel {
	private String first_name, last_name, contact_no, email_id, old_password, new_password, confirm_password,celebrity_name,search_key,comment;
    private int user_id,follow_id, celebrity_id,count, post_id_or_news_id, activity_id,comment_id,like_count,liked_activity_id,comment_count,like_id,follower_count;
