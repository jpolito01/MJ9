...
console.log($(".leftbarPolitician").outerHeight()+"  "+$('.sidebar .row1').outerHeight());
//	$('.sidebar').sticky('.main-div'); // Initialize the sticky scrolling on an item
var leftBar=$(".leftbarPolitician").outerHeight();
		  var hT = $('.sidebar').offset().top,
		   // hH = $('#scroll-to').outerHeight(),
		    he = $('.sidebar .row1').outerHeight();
		  if(leftBar>he){
		    wH = $(window).height();
		   var headerStyle=$('.header-style').height();
		 //  console.log("header style alert"+headerStyle);
