...
<!-- <div id="my_header" class="container left-right-zero header-style main-container" style="background: url(resources/assets/images/inside-header.jpg); width:100%;background-repeat: no-repeat;padding-left: 0px;padding-right: 0px;"> -->
<div id="my_header" class="container left-right-zero header-style main-container insideHeader">
	...
	<div class="col-md-10"></div>
		...
		<img src="resources/assets/images/user-settings.png" height="30px" width="30px"> 
...
<nav class="navbar navbar-toggleable-md navbar-light navbar-size navbar_font" id="navBarInsideHeader">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
						    <ul class="navbar-nav mr-auto">
						    	<li class="nav-item middle-border">
							        		<a id="home" class="nav-link menubar-li-padding nav-hover-link" href="home">Home</a>
							      </li>
						    <c:if test="${role_id==1}">
						   		<li class="nav-item middle-border">
							        		<a id="dashboard" class="nav-link menubar-li-padding nav-hover-link" href="admin-home">Dashboard</a>
							      </li>
							      </c:if>
							      ...
							      <c:forEach var="ca" items="${all_categories}" varStatus="st">
									<li class="dropdown dropdown-large middle-border" id="${st.index}">
										<a id="cat${ca.getCategory_id()}" href="#" class="nav-link menubar-li-padding nav-hover-link" data-toggle="dropdown" onmouseover="hover('img${ca.getCategory_id()}');" onmouseout="unhover('img${ca.getCategory_id()}');">${ca.getCategroy_name()} <span class="caret-padding"> <img id="img${ca.getCategory_id()}" src="resources/assets/images/expand.png" width="10px" style="height:10px"></span></a>
										<div class="dropdown-menu dropdown-menu-large bg-faded">
											<!-- <div class="row"> -->
												<c:choose>
												<c:when test="${ca.getCategory_id()==4}">
													<%-- <c:forEach var="ap" items="${precident_politicians}">
							...
							<li class="nav-item middle-border">
							        		<a id="blogs" class="nav-link menubar-li-padding nav-hover-link" href="blogs">Blogs</a>
							</li>
							<li class="nav-item middle-border">
							        		<a id="bills" class="nav-link nav-hover-link" href="bills">Bills & resolutions</a>
							</li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-header-background" align="center">
        <h3 class="modal-title modal-title" id="exampleModalLabel">Login</h3>
...
<div class="modal fade" id="RegisterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-header-background" align="center">
        <h5 class="modal-title modal-title" id="exampleModalLabel">Register</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="forgot_password_modal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header modal-header-background" align="center">
		        <h5 class="modal-title forgot-modal-title" id="exampleModalLabel">Forgot Password</h5>
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		    </div>
		    <div class="modal-body pod-text" align="center">
		    	<form action="" id="forgot_password">
		    		<div class="row">
		    		<div class="col-md-12"><span id="forgot_pass_err" style="color:red"></span></div>
		    		</div>
			    	<div class="row form-group">
	...
	if($(window).width() >= 700){
	  $(window).scroll(function() {
	        ...
	        if ($(window).scrollTop() > 40) {
	          $(".insideHeader").attr("id","minimizedHeader");
	       
	        } else {
		          $(".insideHeader").removeAttr("id","minimizedHeader");
