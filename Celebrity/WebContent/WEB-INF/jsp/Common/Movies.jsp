...
<%@ include file="/WEB-INF/jsp/header.jsp"%>
	<div id="my_page_container" class="container left-right-zero page-padding-top my_container_height" style="background-color: white; width: 100%;">
		<div class="col-sm-12 padding-one">
			<div class="col-sm-12">
				<label class="title">Movies</label>
			</div>
			<div class="col-sm-12">
				<c:forEach var="i" begin="65" end="90">
				    <a style="text-decoration: none;" class="padding-one" href="movie?q=<%=Character.toChars((Integer)pageContext.getAttribute("i"))%>">
							...
							<div class="col-sm-12 profile-content removePaddings">
								...
								<div class="col-sm-12 padding-one">
									<c:if test="${ci.getFollower_id()==user_id}">
										...
										<a href="#" data-toggle="modal" data-target="#unfollowCelebrityModal" onclick="unfollowCelebrity('${ci.getId()}','movie')"><button type="button" class="btn-follow">Unfollow</button></a>
									</c:if>
									<c:if test="${ci.getFollower_id()!=user_id}">
