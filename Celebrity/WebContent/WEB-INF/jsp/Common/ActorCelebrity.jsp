...
<%@ include file="/WEB-INF/jsp/header.jsp"%>
	<div id="my_page_container" class="container left-right-zero page-padding-top my_container_height" style="background-color: white; width: 100%;">
		<div class="col-sm-12 padding-one">
			<div class="col-sm-12">
				<label class="title">All Celebrities</label>
			</div>
			<div class="col-sm-12">
				<c:forEach var="i" begin="65" end="90">
				    <a style="text-decoration: none;" class="padding-one" href="all-celebrities?q=<%=Character.toChars((Integer)pageContext.getAttribute("i"))%>">
							...
							<div class="col-sm-12 profile-content">
								...
								<div class="col-sm-12 padding-one">
									<c:if test="${ci.getFollower_id()==user_id}">
										...
										<a href="#" data-toggle="modal" data-target="#unfollowCelebrityModal" onclick="unfollowCelebrity('${ci.getId()}','celebrity')"><button type="button" class="btn-follow">Unfollow</button></a>
									</c:if>
									<c:if test="${ci.getFollower_id()!=user_id}">
...
$(document).ready(function(){
	...
	$("#all-celebrities-tab").addClass("active");
